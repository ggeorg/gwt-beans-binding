 ...
 * {@code refreshAndNotify}. No further automatic syncing is done. </td>
 * </tr>
 * <tr>
 * <td colspan="3"><br>
 * </td>
 ...
 * value, or the target changes from unwriteable to writeable. </td>
 * </tr>
 * <tr>
 * <td colspan="3"><br>
 * </td>
 ...
 * {@code refresh}. If the call succeeds, notifies the binding listeners of a
 * successful sync. If the call returns failure, then tries to instead sync the
 * source from the target by calling {@code save}. If this second call
 * succeeds, notifies the binding listeners of a successful sync. If it returns
 * failure, notifies the binding listeners of a failed sync, indicating the
 * reason for the original refresh failure.
 * <p>
 * Automatically responds to changes in the state of the source as follows: If
 ...
 * {@code saveAndNotify}.
 * <p>
 * Automatically responds to changes in the state of the target as follows: If
 ...
 * sync the target from the source by calling {@code refresh}. If this
 * succeeds, notify the listeners of successful sync. Otherwise notify them of
 * failure with the reasons for the original save failure. </td>
 * </tr>
 * </table>
 * </p>
 * 
...
public class AutoBinding<SS, SV, TS, TV> extends Binding<SS, SV, TS, TV> {
   ...
   * {@code AutoBinding}. See {@code AutoBinding's} class level <a
   * href="AutoBinding.html#STRATEGY_BEHAVIOR">documentation</a> for complete
   * details on the sync behavior for each possible update strategy.
   */
  public enum UpdateStrategy {
    /**
     * An update strategy where the {@code AutoBinding} tries to sync the target
