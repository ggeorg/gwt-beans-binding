...
public abstract class Validator<T> {
   ...
   * <p>
   * A {@code Result} can contain an error code and/or description. These values
   * are for your own reporting purposes and are not used internally.
   */
  public class Result {
     ...
     *          {@code null}
     * @param description description a textual description of the
     *          {@code Result}, may be {@code null}
     */
